...
public class QnaController {
	...
	public String boardDelete(@RequestParam(value="qna_num", required=true) int qna_num, HttpSession session, HttpServletResponse response) throws Exception {
	...
	public String qnaReply(QnaVO qna,HttpSession session,HttpServletResponse response) throws Exception {
